...
class Ui_ReceiveWindow(object):
    def setupUi(self, ReceiveWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(260, 250, 111, 36))
        font = QtGui.QFont()
        ...
        self.selleridLE = QtWidgets.QLineEdit(self.centralwidget)
        self.selleridLE.setGeometry(QtCore.QRect(390, 250, 251, 36))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.selleridLE.setFont(font)
        self.selleridLE.setObjectName("selleridLE")
        ...
        self.checkButton.setGeometry(QtCore.QRect(740, 250, 121, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rcvTable.setGeometry(QtCore.QRect(170, 340, 700, 300))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rcvTable.setColumnCount(3)
    ...
    def retranslateUi(self, ReceiveWindow):
        ...
        self.checkButton.setText(_translate("ReceiveWindow", "Check"))
